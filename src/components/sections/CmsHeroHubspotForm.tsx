...
const HERO_FORM_SHELL_CLASS =
  'hero-hubspot-form-shell relative w-full min-w-0 scroll-m-14 scroll-mt-28 md:sticky md:top-20 max-w-[537px] rounded-[12px] bg-white p-4 shadow-sm sm:p-6 md:rounded-[24px] md:p-8'
