...
export default function SEOHead({
  ...
  // Default values
  const defaultTitle =
    title || 'Resources | On-Demand Learning Resources | OS Dental'
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content={
            ogImage ||
            'https://cdn.sanity.io/images/bbmnn1wc/production/b5665765dd8b070505dbabeb87f1fc95536b1a83-1200x1200.jpg'
          }
          key="ogImage"
        />
        {defaultUrl && (
